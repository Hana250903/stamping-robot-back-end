...
namespace StamingRobot.Repository.Migrations
{
    ...
    [Migration("20250227143742_fix_all_db")]
    partial class fix_all_db
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StamingRobot.Repository.Entities.StampingJobParameters", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<float>("RotationWrist")
                        .HasColumnType("real")
                    ...
                    b.HasKey("Id")
                        .HasName("PK_StampingJobParameter");

                    b.HasIndex("JobId")
                        .IsUnique();

                    b.ToTable("StampingJobParameters", (string)null);
                });
            ...
            modelBuilder.Entity("StamingRobot.Repository.Entities.StampingJobParameters", b =>
                {
                    b.HasOne("StamingRobot.Repository.Entities.StampingJob", "StampingJob")
                        .WithOne("StampingJobParameters")
                        .HasForeignKey("StamingRobot.Repository.Entities.StampingJobParameters", "JobId")
                        .IsRequired()
            ...
            modelBuilder.Entity("StamingRobot.Repository.Entities.StampingJob", b =>
                {
                    b.Navigation("StampingJobParameters")
                        .IsRequired();
